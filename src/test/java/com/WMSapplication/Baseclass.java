...
public  class Baseclass {
	...
	public static WebDriver browsers(String browser) {
		if (browser.equals("Chrome")) {
			System.setProperty("webdriver.chrome.driver", "D:\\New folder\\Study\\WMSapplication\\src\\Driver\\chromedriver.exe");
	...
	public static void dropdown1(String value,String option, WebElement element) {
	...
	public static void dropdown(WebElement object, String text) {
		// TODO Auto-generated method stub
            Select country = new Select(object);
